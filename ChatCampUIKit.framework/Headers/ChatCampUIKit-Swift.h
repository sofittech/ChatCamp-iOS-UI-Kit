...
SWIFT_CLASS("_TtC13ChatCampUIKit17ChatTableViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified accessoryLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified unreadCountLabel;
